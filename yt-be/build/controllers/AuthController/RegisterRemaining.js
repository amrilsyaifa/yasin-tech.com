...
const RegisterRemaining = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { params } = req;
        const id = params.id;
        const response = AuthValidation_1.RegisterRemainSchema.safeParse(req.body);
        if (!response.success) {
        ...
        const defaultRole = yield RoleModel_1.default.findOne({
            slug: "guest",
        });
        if (defaultRole) {
            const usrTemp = yield UserTempModel_1.default.deleteOne({ _id: id });
            ...
            const cookieOptions = yield (0, tokenHelper_1.processNewToken)(userSave._id);
...
exports.default = RegisterRemaining;
