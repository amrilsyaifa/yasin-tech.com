...
const GetByIdPost = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { params } = req;
        const posts = yield PostModel_1.default.findOne({ slug: params.id })
            .populate({
            path: "author",
            model: "User",
            populate: {
