...
const GetAllTestimony = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const status = req.query.status;
        const testimony = yield TestimonyModel_1.default.find({ status }).populate({
            path: "author",
            model: "User",
            populate: {
                path: "profile",
...
exports.default = GetAllTestimony;
