...
const UpdateTestimony = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { id } = req.params;
        const propsUpdate = req.body;
        const testimony = yield TestimonyModel_1.default.updateOne({ _id: id }, {
...
exports.default = UpdateTestimony;
